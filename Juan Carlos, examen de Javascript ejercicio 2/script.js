// Función para validar la contraseña (8 dígitos mas punto o guión)
...
function validarFormulario() {
    ...
    if (contraseñaError) contraseñaError.textContent = "";
    ...
    if (!contraseña || contraseña.value.trim() === "") {
        if (contraseñaError) contraseñaError.textContent = "Contraseña requerida.";
        valid = false;
    }
